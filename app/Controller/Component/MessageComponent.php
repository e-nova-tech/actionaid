...
/**
 * Message Component
 * This class replace $session->flash and offers more functionalities
 * to qualify the messages that will be displayed to the user 
 *
 * @package     app.Controller.Component.MessageComponent
