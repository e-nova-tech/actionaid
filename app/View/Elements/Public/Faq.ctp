  <div class="faq-content">
    ...
    <div class="accordion">
      <ul class="questions">
        ...
        <li>
          <h4>What is Child Sponsorship?</h4>
          <div>
          <p>
        ...
        <li>
          <h4>Can I claim tax benefits?</h4>
          <div>
          <p>
        ...
        <li>
          <h4>Is the online payment option secure?</h4>
          <div>
          <p>
        ...
        <li>
          <h4>What is the legal status of ActionAid?</h4>
          <div>
          <p>
