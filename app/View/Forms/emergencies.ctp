		...
		<div class="main-content">
			<div class="left-part">
				...
				<div class="second_block">
					...
					<p> Floods  have struck vast areas of Uttar Pradesh, Uttarakhand, Assam, Bihar and Odisha. There is an urgent and immediate need for shelter, food and hygiene support. We have already conducted rapid needs assessment in the areas that we work, and are already trying to meet the most urgent requirement in most of the areas we work in.</p>
					<p><strong>	At the moment we are focusing on shelter, water and sanitation. Food and clothing are being provided in those areas where there are no other government or other agencies have reached yet. </strong></p>
					<p><strong>We are relying on your valuable contributions in trying times like these.</strong></p>
				</div>
				<div class="clear"></div>
				<div class="left-bottom">
				 <table border="0" cellpadding="18" cellspacing="0" width="100%" style="border: 1px solid #999999;background-color: #EBEBEB;">
									<tbody><tr>
										<td valign="top" ><em><strong>
										  Our immediate efforts are to provide clean drinking water, tarpaulin for shelter, food packets, temporary toilets and candles to those affected, especially, children, girls, young mothers and pregnant women.
									  </strong></em></td>
									</tr>
								</tbody>
				</table>
